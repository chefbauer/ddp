...
DDPAddressableLightEffectBG::DDPAddressableLightEffectBG(const std::string &name) : AddressableLightEffect(name) {}

const std::string &DDPAddressableLightEffectBG::get_name() { return AddressableLightEffect::get_name(); }

void DDPAddressableLightEffectBG::start() {
...
void DDPAddressableLightEffectBG::stop() {
...
void DDPAddressableLightEffectBG::apply(light::AddressableLight &it, const Color &current_color) {
...
uint16_t DDPAddressableLightEffectBG::process_(const uint8_t *payload, uint16_t size, uint16_t used) {
...
float DDPAddressableLightEffectBG::scan_packet_and_return_multiplier_(const uint8_t *payload, uint16_t start, uint16_t end) {
...
float DDPAddressableLightEffectBG::multiplier_from_max_val_(uint8_t max_val) {
  if ( max_val == 0 ) { return 1.0f; }
  else { return this->state_->remote_values.get_brightness()*255.0f/(float)max_val; }
}

void DDPAddressableLightEffectBG::set_max_brightness_() {
